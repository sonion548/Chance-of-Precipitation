...
export const ICON_RECIPES = {
  ...
  /* ---- the niche batch: each one draws the *condition*, not the stat ---- */
  leaden_yoke: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(199,208,224,0.16)');
    g.bar(0.5, 0.3, 0.62, 0.06, 0, C.steel, 0.5);
    g.bar(0.5, 0.34, 0.05, 0.34, 0, '#8fa0bb', 0.4);
    g.poly(0.26, 0.6, 0.16, 4, Math.PI / 4, C.dark);
    g.poly(0.74, 0.66, 0.22, 4, Math.PI / 4, C.steel);
    g.disc(0.5, 0.24, 0.06, C.gold);
  },
  chalk_line: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(255,224,75,0.16)');
    g.bar(0.42, 0.56, 0.62, 0.08, -0.5, C.bone, 0.2);
    g.bar(0.62, 0.36, 0.34, 0.08, 1.07, C.bone, 0.2);
    g.dots(0.5, 0.5, 0.36, 3, 0.03, C.volt, 1.2);
    g.ring(0.5, 0.5, 0.42, 0.025, 'rgba(255,224,75,0.5)');
  },
  dull_whetstone: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(199,208,224,0.14)');
    g.bar(0.5, 0.6, 0.66, 0.22, -0.12, '#6b7285', 0.25);
    g.bar(0.5, 0.55, 0.6, 0.06, -0.12, '#98a2b6', 0.4);
    g.blade(0.5, 0.32, 0.42, 0.14, -0.35, C.steel);
    g.dots(0.36, 0.68, 0.1, 3, 0.022, C.dark, 0.6);
  },
  coin_poultice: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(255,207,92,0.18)');
    g.bar(0.5, 0.56, 0.5, 0.44, 0, '#9aa4b8', 0.16);
    g.bar(0.5, 0.34, 0.56, 0.08, 0, C.steel, 0.3);
    g.arc(0.5, 0.34, 0.2, Math.PI, Math.PI * 2, 0.05, C.gold);
    g.plus(0.5, 0.6, 0.13, 0.05, C.leaf);
  },
  tin_ear: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(143,216,255,0.18)');
    g.arc(0.5, 0.44, 0.24, Math.PI, Math.PI * 2, 0.09, '#9aa4b8');
    g.bar(0.5, 0.56, 0.42, 0.07, 0, C.steel, 0.4);
    g.disc(0.5, 0.66, 0.07, C.dark);
    g.arc(0.5, 0.5, 0.4, 3.6, 5.8, 0.03, 'rgba(143,216,255,0.55)');
  },
  cracked_lens: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(74,168,255,0.18)');
    g.ring(0.5, 0.5, 0.34, 0.06, C.dark);
    g.disc(0.5, 0.5, 0.3, 'rgba(74,168,255,0.45)');
    g.bar(0.5, 0.5, 0.6, 0.03, 0.7, C.shadow, 0.5);
    g.bar(0.46, 0.5, 0.4, 0.025, -0.5, C.shadow, 0.5);
    g.arc(0.42, 0.4, 0.14, 3.6, 5.0, 0.04, '#bfe4ff');
  },
  relay_coil: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(70,224,192,0.2)');
    g.arc(0.5, 0.5, 0.32, -0.4, 3.6, 0.09, C.teal);
    g.tri(0.78, 0.36, 0.2, 0.18, 0.6, C.teal);
    g.arc(0.5, 0.5, 0.18, 2.8, 6.2, 0.07, '#9fffe8');
    g.disc(0.5, 0.5, 0.07, C.dark);
  },
  tidebound_censer: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(75,224,138,0.2)');
    g.bar(0.5, 0.62, 0.4, 0.34, 0, '#8a7a5c', 0.4);
    g.arc(0.5, 0.44, 0.22, Math.PI, Math.PI * 2, 0.05, C.gold);
    g.drop(0.5, 0.5, 0.13, C.leaf);
    g.dots(0.5, 0.3, 0.16, 3, 0.026, 'rgba(111,220,127,0.7)');
  },
  thresher_bearing: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(255,207,92,0.2)');
    g.gear(0.5, 0.5, 0.4, 8, '#8fa0bb');
    g.ring(0.5, 0.5, 0.2, 0.06, C.dark);
    g.dots(0.5, 0.5, 0.29, 8, 0.03, C.gold);
    g.disc(0.5, 0.5, 0.08, C.gold);
  },
  sixth_sense: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(143,216,255,0.2)');
    g.arc(0.5, 0.5, 0.34, 3.35, 6.07, 0.07, C.ice);
    g.arc(0.5, 0.5, 0.34, 0.21, 2.93, 0.07, C.ice);
    g.disc(0.5, 0.5, 0.15, '#dff2ff');
    g.disc(0.5, 0.5, 0.08, C.shadow);
    g.dots(0.5, 0.5, 0.44, 6, 0.022, 'rgba(143,216,255,0.5)');
  },
  kiln_brand: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(255,106,42,0.24)');
    g.bar(0.5, 0.66, 0.09, 0.44, 0, '#6b5340', 0.4);
    g.poly(0.5, 0.34, 0.24, 6, 0.4, C.ember);
    g.poly(0.5, 0.34, 0.13, 6, 0.4, C.volt);
    g.dots(0.5, 0.2, 0.12, 3, 0.022, 'rgba(255,154,61,0.8)');
  },
  grave_ledger: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(199,208,224,0.14)');
    g.bar(0.5, 0.52, 0.56, 0.62, 0, '#3a3f4d', 0.12);
    g.bar(0.5, 0.52, 0.44, 0.54, 0, C.bone, 0.08);
    g.bar(0.5, 0.52, 0.04, 0.62, 0, '#6b7285', 0.3);
    for (let i = 0; i < 4; i++) g.bar(0.62, 0.34 + i * 0.11, 0.2, 0.025, 0, '#8a8f9c', 0.5);
    g.disc(0.36, 0.36, 0.05, C.blood);
  },
  backup_capacitor: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(74,168,255,0.22)');
    g.bar(0.38, 0.52, 0.26, 0.5, 0, '#4a5568', 0.2);
    g.bar(0.62, 0.52, 0.26, 0.5, 0, '#4a5568', 0.2);
    g.bar(0.38, 0.4, 0.26, 0.16, 0, C.deep, 0.2);
    g.bar(0.62, 0.4, 0.26, 0.16, 0, C.deep, 0.2);
    g.bar(0.5, 0.22, 0.5, 0.06, 0, C.steel, 0.4);
    g.bolt(0.5, 0.56, 0.5, C.volt);
  },
  split_cell: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(255,224,75,0.2)');
    g.bar(0.34, 0.54, 0.24, 0.56, 0, '#4a5568', 0.2);
    g.bar(0.66, 0.54, 0.24, 0.56, 0, '#4a5568', 0.2);
    g.bar(0.34, 0.62, 0.2, 0.3, 0, C.volt, 0.3);
    g.bar(0.66, 0.62, 0.2, 0.3, 0, C.volt, 0.3);
    g.bar(0.5, 0.5, 0.03, 0.72, 0, C.shadow, 0.5);
    g.bar(0.34, 0.22, 0.12, 0.07, 0, C.steel, 0.4);
    g.bar(0.66, 0.22, 0.12, 0.07, 0, C.steel, 0.4);
  },
  tessellate_prism: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(143,216,255,0.2)');
    g.poly(0.5, 0.42, 0.3, 3, -Math.PI / 2, C.ice);
    g.poly(0.35, 0.68, 0.18, 3, Math.PI / 2, 'rgba(143,216,255,0.6)');
    g.poly(0.65, 0.68, 0.18, 3, Math.PI / 2, 'rgba(143,216,255,0.6)');
    g.poly(0.5, 0.42, 0.14, 3, -Math.PI / 2, '#ffffff');
  },
  umbilical_tether: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(180,115,255,0.2)');
    g.arc(0.5, 0.5, 0.3, 0, Math.PI * 1.6, 0.1, '#8a7a5c');
    g.arc(0.5, 0.5, 0.18, Math.PI, Math.PI * 2.7, 0.08, '#a89272');
    g.disc(0.5, 0.5, 0.08, C.violet);
    g.dots(0.5, 0.5, 0.42, 4, 0.026, 'rgba(180,115,255,0.6)');
  },
  marrow_siphon: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(239,230,210,0.2)');
    g.bar(0.5, 0.5, 0.1, 0.5, 0.35, C.bone, 0.5);
    g.disc(0.35, 0.31, 0.09, C.bone);
    g.disc(0.42, 0.26, 0.08, C.bone);
    g.disc(0.65, 0.69, 0.09, C.bone);
    g.disc(0.58, 0.74, 0.08, C.bone);
    g.drop(0.72, 0.34, 0.11, C.blood);
  },
  weeping_mask: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(74,168,255,0.18)');
    g.shield(0.5, 0.48, 0.56, 0.66, '#8fa0bb');
    g.disc(0.38, 0.44, 0.06, C.shadow);
    g.disc(0.62, 0.44, 0.06, C.shadow);
    g.drop(0.38, 0.6, 0.07, C.deep);
    g.drop(0.62, 0.62, 0.06, C.deep);
  },
  overflow_manifold: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(143,216,255,0.2)');
    g.bar(0.5, 0.52, 0.6, 0.42, 0, '#3d4657', 0.16);
    for (let i = 0; i < 4; i++) g.bar(0.28 + i * 0.15, 0.52, 0.1, 0.3, 0, C.ice, 0.3);
    g.bar(0.5, 0.26, 0.3, 0.08, 0, C.steel, 0.4);
    g.dots(0.5, 0.76, 0.28, 4, 0.024, 'rgba(143,216,255,0.7)');
  },
  cartographers_compass: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(70,224,192,0.2)');
    g.ring(0.5, 0.5, 0.38, 0.07, '#8a7a5c');
    g.disc(0.5, 0.5, 0.31, '#20262f');
    g.tri(0.5, 0.38, 0.16, 0.28, 0, C.blood);
    g.tri(0.5, 0.62, 0.16, 0.28, Math.PI, C.bone);
    g.disc(0.5, 0.5, 0.05, C.gold);
    g.dots(0.5, 0.5, 0.44, 4, 0.02, C.teal);
  },
  hollow_reliquary: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(255,207,92,0.2)');
    g.bar(0.5, 0.62, 0.42, 0.4, 0, '#6b5a3a', 0.3);
    g.arc(0.5, 0.44, 0.24, Math.PI, Math.PI * 2, 0.06, C.gold);
    g.bar(0.5, 0.82, 0.5, 0.08, 0, '#8a7a5c', 0.3);
    g.disc(0.5, 0.56, 0.11, C.shadow);
    g.dots(0.5, 0.3, 0.14, 3, 0.024, 'rgba(255,207,92,0.75)');
  },
  nine_lives_filament: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(239,230,210,0.2)');
    g.arc(0.5, 0.5, 0.3, 0.4, 3.2, 0.05, C.bone);
    g.arc(0.5, 0.5, 0.2, 3.0, 6.0, 0.05, C.bone);
    g.arc(0.5, 0.5, 0.38, 2.2, 4.2, 0.04, 'rgba(239,230,210,0.6)');
    g.disc(0.5, 0.5, 0.06, C.gold);
    g.bar(0.5, 0.16, 0.06, 0.16, 0.5, C.steel, 0.4);
  },
  echoing_vault: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(180,115,255,0.22)');
    g.disc(0.36, 0.5, 0.14, C.violet);
    g.arc(0.36, 0.5, 0.25, -1.0, 1.0, 0.055, 'rgba(180,115,255,0.85)');
    g.arc(0.36, 0.5, 0.36, -0.9, 0.9, 0.045, 'rgba(180,115,255,0.55)');
    g.arc(0.36, 0.5, 0.47, -0.8, 0.8, 0.035, 'rgba(180,115,255,0.3)');
  },
  crescendo_core: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(255,207,92,0.28)');
    g.arc(0.5, 0.5, 0.36, 2.2, 5.6, 0.09, C.gold);
    g.tri(0.72, 0.68, 0.26, 0.22, -0.9, C.gold);
    g.disc(0.5, 0.5, 0.17, C.ember);
    g.star(0.5, 0.5, 0.13, 0.05, 5, -Math.PI / 2, C.volt);
  },
  perpetual_loom: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(143,216,255,0.22)');
    for (let i = 0; i < 3; i++) {
      const a = (i / 3) * Math.PI * 2 - Math.PI / 2;
      g.ring(0.5 + Math.cos(a) * 0.16, 0.5 + Math.sin(a) * 0.16, 0.21, 0.05, 'rgba(143,216,255,0.85)');
    }
    g.disc(0.5, 0.5, 0.09, '#ffffff');
  },
  mirror_tithe: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(143,216,255,0.22)');
    g.ring(0.5, 0.5, 0.36, 0.07, '#8a7a5c');
    g.disc(0.5, 0.5, 0.3, 'rgba(143,216,255,0.35)');
    g.bar(0.42, 0.5, 0.62, 0.03, -0.7, '#ffffff', 0.5);
    g.bar(0.58, 0.52, 0.4, 0.025, -0.7, 'rgba(255,255,255,0.6)', 0.5);
    g.drop(0.5, 0.56, 0.1, C.blood);
  },
  locust_codex: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(255,138,61,0.2)');
    g.bar(0.5, 0.54, 0.62, 0.5, 0, '#4a3a2a', 0.14);
    g.bar(0.5, 0.54, 0.56, 0.42, 0, C.bone, 0.06);
    g.bar(0.5, 0.54, 0.035, 0.5, 0, '#6b5340', 0.4);
    g.dots(0.32, 0.46, 0.08, 3, 0.022, C.ember, 0.4);
    g.dots(0.68, 0.6, 0.08, 3, 0.022, C.amber, 1.2);
    g.star(0.5, 0.24, 0.09, 0.035, 5, -Math.PI / 2, C.gold);
  },

  /* ---- equipment ---- */
  ionic_lance: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(143,216,255,0.26)');
    g.bar(0.5, 0.5, 0.86, 0.09, -0.5, C.ice, 0.5);
    g.bar(0.5, 0.5, 0.5, 0.03, -0.5, '#ffffff', 0.5);
    g.tri(0.76, 0.26, 0.2, 0.24, 0.6, '#ffffff');
    g.disc(0.28, 0.72, 0.1, C.deep);
  },
  recall_beacon: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(70,224,192,0.24)');
    g.bar(0.5, 0.62, 0.08, 0.46, 0, C.steel, 0.4);
    g.tri(0.5, 0.32, 0.34, 0.3, 0, C.teal);
    g.disc(0.5, 0.32, 0.08, C.shadow);
    g.arc(0.5, 0.82, 0.22, Math.PI, Math.PI * 2, 0.04, 'rgba(70,224,192,0.6)');
  },
  effigy_of_spite: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(255,106,208,0.24)');
    g.tri(0.5, 0.56, 0.42, 0.66, 0, '#6b5a52');
    g.disc(0.42, 0.5, 0.055, C.rose);
    g.disc(0.58, 0.5, 0.055, C.rose);
    g.bar(0.5, 0.66, 0.18, 0.04, 0, C.rose, 0.5);
    g.dots(0.5, 0.5, 0.44, 6, 0.02, 'rgba(255,106,208,0.5)');
  },
  collapse_charge: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(154,91,255,0.3)');
    g.ring(0.5, 0.5, 0.4, 0.04, 'rgba(180,115,255,0.5)');
    g.ring(0.5, 0.5, 0.28, 0.05, 'rgba(180,115,255,0.75)');
    g.disc(0.5, 0.5, 0.17, C.shadow);
    g.ring(0.5, 0.5, 0.17, 0.03, C.violet);
    g.dots(0.5, 0.5, 0.47, 6, 0.022, C.violet);
  },
  volatile_serum: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(255,77,94,0.24)');
    g.flask(0.5, 0.54, 0.3, C.blood, C.steel);
    g.dots(0.5, 0.6, 0.12, 3, 0.026, '#ffb0b8');
    g.bar(0.5, 0.18, 0.16, 0.07, 0, C.dark, 0.4);
  },
  gravity_well: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(180,115,255,0.26)');
    g.arc(0.5, 0.5, 0.4, 0, 4.6, 0.05, 'rgba(180,115,255,0.5)');
    g.arc(0.5, 0.5, 0.28, 1.4, 5.6, 0.06, 'rgba(180,115,255,0.8)');
    g.arc(0.5, 0.5, 0.16, 2.6, 6.2, 0.07, C.violet);
    g.disc(0.5, 0.5, 0.06, C.shadow);
  },
  field_medkit: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(75,224,138,0.24)');
    g.bar(0.5, 0.56, 0.66, 0.44, 0, '#d8dee9', 0.16);
    g.bar(0.5, 0.36, 0.24, 0.1, 0, '#9aa4b8', 0.3);
    g.plus(0.5, 0.58, 0.16, 0.06, C.leaf);
  },
  chrono_anchor: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(143,216,255,0.24)');
    g.ring(0.5, 0.5, 0.36, 0.06, C.steel);
    g.disc(0.5, 0.5, 0.3, 'rgba(143,216,255,0.3)');
    g.bar(0.5, 0.42, 0.04, 0.2, 0, '#ffffff', 0.5);
    g.bar(0.58, 0.52, 0.04, 0.16, 1.6, '#ffffff', 0.5);
    g.dots(0.5, 0.5, 0.44, 8, 0.018, 'rgba(143,216,255,0.5)');
  },
  prospectors_charge: (g) => {
    g.glow(0.5, 0.5, 0.46, 'rgba(255,207,92,0.26)');
    g.disc(0.5, 0.56, 0.28, C.gold);
    g.disc(0.5, 0.56, 0.19, '#ffe9a8');
    g.bar(0.5, 0.22, 0.08, 0.24, 0, '#8a7a5c', 0.4);
    g.dots(0.5, 0.56, 0.42, 5, 0.026, 'rgba(255,207,92,0.6)');
  },
};
